...
public interface AppFileComponent {
    ...
    public void saveSchData(AppDataComponent data, String filePath) throws IOException;
    public void saveTAData(AppDataComponent data, String filePath) throws IOException;
    public void saveTeamAndStudentData(AppDataComponent data, String filePath) throws IOException;
