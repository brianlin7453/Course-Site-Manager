...
public class AppGUI {
    ...
    protected FlowPane editControlPane;
    ...
    private void initFileToolbar(AppTemplate app) {
        ...
        undoButton = initChildButton(editControlPane, UNDO_ICON.toString(), UNDO_TOOLTIP.toString(),false);
        redoButton = initChildButton(editControlPane, REDO_ICON.toString(), REDO_TOOLTIP.toString(),false);
        aboutButton = initChildButton(editControlPane, ABOUT_ICON.toString(), ABOUT_TOOLTIP.toString(),false);
        
        topPane.getChildren().add(fileToolbarPane);
        topPane.getChildren().add(editControlPane);
