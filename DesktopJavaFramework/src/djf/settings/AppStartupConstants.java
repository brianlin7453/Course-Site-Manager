...
public class AppStartupConstants
{
    ...
    public static final String SAPP_PROPERTIES_FILE_NAME = "sapp_properties.xml";
    ...
    public static String half = System.getProperty("user.dir");
    static String str = half.replaceAll("\\\\", "/");
    static String one = str.replace("/TAManager", "");
    public static String other = "/TAManagerTester/public_html/";
    public static String PATH_PUBLIC_HTML = one + other;
